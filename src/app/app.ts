...
export class App {
  ...
  protected readonly materials: Material[] = [
    ...
    { name: 'Visagra semi parche cierre lento con apertura de 8 a 9 ml', description: '', price: '$ 2.535', imageUrls: ['assets/images/3.jpeg'], category: 'Puertas' },
    { name: 'Soporte para tubo entrepaño', description: '', price: '$ 279', imageUrls: ['assets/images/4.jpeg'], category: 'Muebles' },
    ...
    { name: 'Juegos para riel corredizo puertas', description: '', price: '$ 15.000', imageUrls: ['assets/images/16.jpeg'], category: 'Puertas', imageSize: 'compact' },
    { name: 'Soporte entrepaño trasparente', description: '', price: '$ 81', imageUrls: ['assets/images/27.jpeg'], category: 'Muebles', imageSize: 'compact' },
